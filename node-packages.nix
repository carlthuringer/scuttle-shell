...
let
  sources = {
    ...
    "flumeview-search-1.0.4" = {
      ...
      version = "1.0.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/flumeview-search/-/flumeview-search-1.0.4.tgz";
        sha512 = "iHg3sfqiRAaRU1K+Ir1TGWMDLGxO6ztLl2RFKMYJsojruk+RbcIQjktjxJ4Pzi1igrZsNYDFMOQXoLtyuQgakg==";
      };
    };
    "for-each-0.3.3" = {
      name = "for-each";
    ...
    "scuttlebot-11.3.3" = {
      ...
      version = "11.3.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/scuttlebot/-/scuttlebot-11.3.3.tgz";
        sha512 = "1F2PVf1HfU3dbCwa5AxKbXEmMEhz0vlsetc5HoBkAr+L4U3SR9NaO+oPNa9NuUc9lVM1wqCrLjDU2nu824bGvQ==";
      };
    };
    ...
    "ssb-backlinks-0.7.2" = {
      ...
      version = "0.7.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/ssb-backlinks/-/ssb-backlinks-0.7.2.tgz";
        sha512 = "qdx+n0+LtnaN68LF0qhfqz/lR2cTvRI3DCQ85WuIm7v1eH/m+9A9bm3DP2nGTUsVbxAtfdSif2kJ41vMshyrgw==";
      };
    };
    "ssb-blobs-1.1.5" = {
      name = "ssb-blobs";
    ...
    "ssb-chess-db-1.0.2" = {
      ...
      version = "1.0.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/ssb-chess-db/-/ssb-chess-db-1.0.2.tgz";
        sha512 = "zzN4PSSe7j1Pt1JGCUItFoMZdKUxnSxXOvU4gGXUqB32xKQaYPDQW8kTs+euQ15nWHgMa4kLxp7wLMxrS7uynQ==";
      };
    };
    "ssb-client-4.5.7" = {
      name = "ssb-client";
    ...
    "ssb-names-3.1.2" = {
      ...
      version = "3.1.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/ssb-names/-/ssb-names-3.1.2.tgz";
        sha512 = "W7ELI/taHGEGPuQ94jIc9xacz37p88XxUvw/7+dZC9emeB3AMm+4Q0Ct4lE2yFQrVd7DONqEpsS/5kxt0kpXkQ==";
      };
    };
    "ssb-ooo-1.0.9" = {
      name = "ssb-ooo";
    ...
    "ssb-private-0.2.1" = {
      ...
      version = "0.2.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/ssb-private/-/ssb-private-0.2.1.tgz";
        sha512 = "Y5t8gS+rrHn9tche3/Vm/di4duciJ3YUjejs6T3e7ESsmj8IyjVKsMrlcCbi/KlQ35wtQeWSwMIY4yKjlrD5uQ==";
      };
    };
    "ssb-query-2.1.0" = {
      name = "ssb-query";
    ...
    "ssb-validate-3.0.9" = {
      ...
      version = "3.0.9";
      src = fetchurl {
        url = "https://registry.npmjs.org/ssb-validate/-/ssb-validate-3.0.9.tgz";
        sha512 = "Gshbb8mgwtfJQTK66mCpORdMhDpe8l0GOv+3em1gWYHadWAV4Rx80RZ1NduD2NVzqupve12Qku5kQnrq0zJqjw==";
      };
    };
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."flumeview-search-1.0.4"
      ...
      sources."ssb-backlinks-0.7.2"
      sources."ssb-blobs-1.1.5"
      sources."ssb-chess-db-1.0.2"
